...
$APPLICATION->SetTitle("Бизнес - центры");
?>

<?$APPLICATION->IncludeComponent("bitrix:news", "biznes-tsenty", Array(
	"ADD_ELEMENT_CHAIN" => "N",	// Включать название элемента в цепочку навигации
		...
		"SEF_FOLDER" => "/obekty/biznes-tsentry/",	// Каталог ЧПУ (относительно корня сайта)
