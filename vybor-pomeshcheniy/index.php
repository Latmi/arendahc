...
$APPLICATION->SetTitle("Выбор помещений");
?>
    ...
    <div class="container selection">
        <div class="row selection__head">
            ...
            <div class="col-lg-6 selection__container_data">
                <div class="row">
                    <div class="col-12">
                        <h5>тип помещения:</h5>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 selection__container_data_range">
                        <p>
                            ...
                            <input class="range_input" type="text" id="minNum" disabled> <span class="mdash">&mdash;</span>
                            <input class="range_input" type="text" id="maxNum" disabled>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row head-item">
                                ...
                                <div class="col-lg col item-table-header">Название</div>
                                <div class="col-lg col item-table-header">Тип</div>
                                <div class="col-lg col item-table-header">Площадь, м<sup>2</sup></div>
                                <div class="col-lg col item-table-header">Метро</div>
                                <div class="col-lg col-1 item-table-header">Описание</div>
        ...
        $(function () {
            ...
            function createDom (url, plan, photo, name, type, square, metro, id, text) {
                ...
                for (var i = 0; i < plan.length; i++) {
                    if (i > 0) {
                        arPlan += '<a style="display: none" data-fancybox="plan'+ id +'" href="'+ plan[i] +'"><i class="far fa-file"></i></a>';
                    } else {
                        arPlan += '<a data-fancybox="plan'+ id +'" href="'+ plan[i] +'"><i class="far fa-file"></i></a>';
                    }
                }
                var arPhoto = '';
                for (var k = 0; k < photo.length; k++) {
                    if (k > 0) {
                        arPhoto += '<a style="display: none" data-fancybox="image'+ id +'" href="'+ photo[k] +'"><i class="far fa-image"></i></a>';
                    } else {
                        arPhoto += '<a data-fancybox="image'+ id +'" href="'+ photo[k] +'"><i class="far fa-image"></i></a>';
                    }
                }
                elRow += '<div id="'+ id +'" class="row py-1 body-item">';
                elRow += '<div class="col-lg col align-self-center item-name"><a href="'+ url +'">'+ name +'</a></div>';
                elRow += '<div class="col-lg col align-self-center item-type">'+ type +'</div>';
                elRow += '<div class="col-lg col-1 align-self-center item-square">'+ square +'</div>';
                elRow += '<div class="col-lg col align-self-center item-metro">'+ metro +'</div>';
                elRow += '<div class="col-lg col-1 align-self-center item-desc"><a data-fancybox="" data-src="#desc'+ id +'" href="javascript:;"><i class="far fa-file-alt"></i></a><div style="display: none" id="desc'+ id +'">'+ text +'</div></div>';
                elRow += '<div class="col-lg col-1 align-self-center item-plan">'+ arPlan +'</div>';
                elRow += '<div class="col-lg col-1 align-self-center item-image">'+ arPhoto +'</div>';
                elRow += '</div>';
            ...
            $.ajax({
                ...
                success: function ( data ) {
                    ...
                    var maxSquare = Math.ceil(Math.max.apply(null, arSquare));
